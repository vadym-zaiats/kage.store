  ...
  return (
    <>
      ...
      <div className={styles.contract__content}>
        ...
        <p>
          4.1. Покупець має право оформити замовлення на будь-який
          товар/послугу, представлений на Сайті Інтернет-магазину і наявний.
        </p>
        <p>
        ...
        <p className={styles.contract__strong}>
          ...
          предмети, які прикріплені до Товарів, та/або включення Образів в
          Товари іншим способом;
        </p>
        ...
        <p>
          ...
          виготовляються за індивідуальним замовленням Клієнта. Обмін і
          повернення товарів p послугою друку, виготовлених на замовлення,
          описаний в статті №13, частина 5, пункт 3 в законі "Про захист прав
          споживачів". А саме "3) договір стосується виготовлення або переробки
          товару на замовлення споживача, тобто якщо товар не може бути
          переданий іншим особам або може бути проданий лише з істотними
          фінансовими втратами для продавця;".
        </p>
        ...
        <p>
          ...
          на сайті https://kage-store.com.ua
        </p>
        <p>
