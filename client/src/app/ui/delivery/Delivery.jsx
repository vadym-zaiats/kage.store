      ...
      <ul>
        ...
        >
          <DeliveryType
            ...
            receivingHow={
              "Зазвичай доведеться постояти в черзі. Після цього назвати оператору номер транспортної накладної, яка Вам прийде в смс на мобільний телефон. Також Вам знадобиться паспорт, щоб підтвердити свою особистість. Уважно огляньте посилку. Якщо Вас все влаштовує, то просто заберіть посилку. Якщо Ви бачите якийсь брак, або щось сталось з відправленням під час транспортування, то зафіксуйте цей факт зі співробітником Укрпошти та далі дійте за його підказками."
            }
          />
        </li>
      </ul>
